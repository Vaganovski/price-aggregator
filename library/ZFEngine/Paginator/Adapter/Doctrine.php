 ...
 */
class ZFEngine_Paginator_Adapter_Doctrine implements Zend_Paginator_Adapter_Interface
{
        /**
        ...
        /**
         * Constructs ZFEngine_Zend_Paginator_Doctrine
         *
        ...
        public function __construct($query, $hydrationMode = null, $options = array())
        {
                if ( is_string($query) ) {
                        ...
                        require_once 'ZFEngine/Paginator/Adapter/Doctrine/Exception.php';
                        throw new ZFEngine_Paginator_Adapter_Doctrine_Exception("Given query is not instance of Doctrine_Query");
                }
                $this->_query = $query;
                ...
                if ( !empty($options['countQuery']) ) {
                        if ( is_string($options['countQuery']) ) {
                                ...
                                require_once 'ZFEngine/Paginator/Adapter/Doctrine/Exception.php';
                                throw new ZFEngine_Paginator_Adapter_Doctrine_Exception("Given count-query is not instance of Doctrine_Query");
                        }
