...
/**
 * ZFEngine View Helper TinyMce
 *
 * Used to render javascript for the TinyMce textarea conversion.
 *
 */
class ZFEngine_View_Helper_TinyMce extends Zend_View_Helper_Abstract
{
    protected $_enabled = false;
    protected $_defaultScript = '/javascripts/tiny_mce/tiny_mce.js';
