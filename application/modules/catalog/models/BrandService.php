...
class Catalog_Model_BrandService extends ZFEngine_Model_Service_Database_Abstract
{
    ...
    public function init()
    {
        ...
        // @todo refact
        $this->_modelName = 'Catalog_Model_Brand';
    }
     ...
     * @return boolean
     */
    public function processFormNew($rawData, $withoutImage = false)
    {
    ...
    public function getModelById($id)
    {
        ...
        if ($product == false) {
            throw new Exception($this->getView()->translate('Производитель не найден.'));
        }
