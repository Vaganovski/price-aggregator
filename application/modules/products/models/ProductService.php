...
class Products_Model_ProductService extends ZFEngine_Model_Service_Database_Abstract
{
    ...
    public function init()
    {
        ...
        // @todo refact
        $this->_modelName = 'Products_Model_Product';
    }
    ...
    public function processFormNew($rawData)
    {
        ...
        if ($form->isValid($rawData)) {
            ...
            try {
                $this->getModel(true)->fromArray($formValues);
                $this->getModel()->save();
                return true;
