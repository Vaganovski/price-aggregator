 ...
 */
class Comments_Form_Decorator_Textarea extends Zend_Form_Decorator_Abstract
{
    /**
    ...
    {
        return '<p class="p2"><textarea style="width: 98%;" cols="" rows="4" name="' . $this->getElement()->getName() . '"></textarea></p>';
    }
